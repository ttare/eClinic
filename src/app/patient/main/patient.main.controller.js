...
angular.module('patient')
  .controller('patient.main.ctrl', function ($rootScope, $scope, $state, authorizationService, dashboardServices, $interval) {
      dashboardServices.getPatientMap(function (result) {
